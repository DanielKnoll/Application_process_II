...
DESC = {"mentors": ["1. Mentors and schools page [/mentors]",
        ...
        "all_school": ["2. All school page [/all-school]",
                       """On this page you should show the result of a query that returns the name of the
                          ...
                          no mentor yet (in that cell, "No data" should be displayed)!""",
        ...
        "hat_owner": ["""4. We called Carol, and she said it's not her hat. It belongs to another girl, who
                        went to the famous Adipiscingenimmi University.""",
                      """You should write a query to get the same informations like with Carol, but for this
                         other girl. The only thing we know about her is her school e-mail address ending:
        ...
        "add_markus": ["""5. After we returned the hat, a new applicant appeared at the school, and he wants
                         ...
                         him the following application code: 54823.""", " ",
                       """After INSERTing the data, write a SELECT query, that returns with all the columns
                          of this applicant! (use the unique application code for your condition!)"""],
        "jemimas_new_number": ["""6. Jemima Foreman, an applicant called us, that her phone number
                                  changed to: 003670/223-7459""",
        ...
        "mauriseu_guys_leaving": ["""7. Arsenio, an applicant called us, that he and his friend applied to Codecool.
                                    ...
                                    they run: mauriseu.net""", " ",
                                  """Write DELETE query to remove all the applicants, who applied with emails for
                                     this domain (e-mail address has this domain after the @ sign)."""],
        }
